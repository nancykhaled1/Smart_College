...
class ChatRemoteDataSource {
  ...
  ChatRemoteDataSource(this.apiManager);

  // Future<Either<LoginError, SendMessageResponse>> sendMessage(String adminId , String userId , String text) {
  //   return apiManager.sendMessage(adminId: adminId, userId: userId, text: text);
  // }
  //
  Future<Either<LoginError, AllMessagesResponse>> getMessages() {
    return apiManager.getMessages();
  }
  //
  // Future<Either<LoginError, DeleteMessageResponse>> deleteMessage(
  //     String msgId) {
  //   return apiManager.deleteMessage(msgId);
  // }
