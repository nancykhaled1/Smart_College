...
import 'package:smart_college/Cubits/Auth/Login/States.dart';
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: BlocConsumer<SendCodeCubit, LoginStates>(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: (state is! LoginLoadingState && viewModel.isCodeComplete)
                            ? () {
